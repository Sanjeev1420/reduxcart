    ...
    reducers: {
        removeProduct: (state, action) => {
          ...
          updatePrice: (state) => {
            ...
            state.netTotal = stotal + state.shippingPrice;
            state.subTotal = stotal;
            state.saved = netTotal - (stotal + state.shippingPrice);
          },
    }
})

export const { removeProduct, updateQuantity, updatePrice } = cartSlice.actions;
